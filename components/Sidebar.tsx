...
const Sidebar = (props: any) => {
 ...
 <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div className="h-full px-3 py-4 bg-gray-50 overflow-auto dark:bg-gray-800">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-400">Make It All</h1>
        </div>
        <div className="flex flex-col justify-between h-max max-h-full">
       <ul className="space-y-2 font-medium min-h-full">
          <li className="group">
             <Link href="/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 no-underline">
                <svg aria-hidden="true" className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
                <span className="ml-3">Dashboard</span>
             </Link>
          </li>
          <li className="group">
             <Link href="/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 no-underline">
          ...
          <li className="group">
             <Link href="/analysis" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 no-underline">
          ...
          <li className="group">
             <Link href="/chat" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 no-underline">
         ...
         {/* Trying to make the logout justify to the bottom of the nav bar but a scroll bar keeps appearing ? */}
         {/* <div className="group">
         <Link href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 no-underline">
             <FontAwesomeIcon icon={faRightFromBracket} className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                <span className="flex-1 ml-3 whitespace-nowrap">Log out</span>
